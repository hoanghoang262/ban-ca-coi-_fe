    ...
    <div className="container mx-auto px-4 py-8 min-h-[calc(100vh-96px)]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        >
          ...
          <h2 className="text-3xl font-semibold mb-4">Create a New Order</h2>
          <p className="text-center mb-6">
            Quickly create a new order by providing the necessary details. Our
            user-friendly interface makes it easy to enter pickup location,
            destination, weight, quantity, and additional services.
          </p>
          <Link
            to="/order/create"
        ...
        >
          ...
          <h2 className="text-3xl font-semibold mb-4">View Order History</h2>
          <p className="text-center mb-6">
            Review your past orders and track their status. Stay informed about
            the progress of your shipments and access detailed information about
            each order.
          </p>
          <Link
            to="/order/history"
      ...
      >
        <div className="md:w-1/2 md:pr-8">
          ...
          <p className="mb-4">
            ...
            Whether you require air, sea, or land transportation, we have you
            covered. Our experienced team ensures that your goods are handled
